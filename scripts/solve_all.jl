...
function solve_all(search_problem, num_instances, rwa_weights, awa_weights, nodes_budget; walltime_limit=Inf)
    ...
    for instance_id in 1:num_instances
        ...
        for w in [rwa_weights, awa_weights...]
            ...
            @info "Solved instance" instance_id h0 w awa.nodes_expended expansion_rate(awa)  awa.num_solutions awa.solution_cost solution_quality
...
rwa_weights = [1, 1.5, 2, 3, 4, 5]
awa_weights = [1, 1.5, 2, 3, 4, 5]
nodes_budget = 6000
num_instances = 100
